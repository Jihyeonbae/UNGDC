...
-   [ ] Experiment2: 10-year, 5 overlap, saved in `moving_0214`. tfidf option: count and inverse. 20 topics
...
lda_generator <- function(corpus, start_year, end_year, window_size = 10, overlap = 5, num_topics = 20) {
  output_dir <- "output/lda/moving_0214"
...
output_directory <- file.path("../output/lda/moving_0209")
